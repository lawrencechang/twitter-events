...
RUN_TAGGER_CMD = "java -XX:ParallelGCThreads=2 -Xmx500m -jar /home/tomerwei/UCLA_assignments/CS263A/ark-tweet-nlp-0.3.2/ark-tweet-nlp-0.3.2.jar"
...
if __name__ == "__main__":
    ...
    if success:
        ...
        testing =  runtagger_parse(tweets)        
        for w in testing:
            for token in w:
